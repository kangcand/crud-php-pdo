                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 bg-light text-right">
                            ...
                            <a href="/dashboard/mahasiswa/create.php"
                                class="btn btn-sm btn-outline-primary float-lg-end">Tambah</a> &nbsp;
                            <a target="_blank" href="/dashboard/mahasiswa/report-excel.php"
                                class="btn btn-sm btn-info float-lg-end mx-2">Export
                                Excel &nbsp;</a>
                            <button onclick="window.open('/dashboard/mahasiswa/report-pdf.php','_blank')"
