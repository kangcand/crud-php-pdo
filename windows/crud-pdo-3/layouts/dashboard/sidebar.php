<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/dashboard/index.php" target="_blank">
            <img src="/crud-pdo-3/assets/dashboard/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
            ...
            <li class="nav-item">
                ...
                <div class="collapse " id="dashboardsExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="/crud-pdo-3/dashboard/mahasiswa/index.php">
    ...
    <!-- <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background"
                style="background-image: url('../crud-pdo-3/assets/dashboard/img/curved-images/white-curved.jpg')"></div>
